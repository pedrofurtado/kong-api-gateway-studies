...
INSERT INTO public.plugins (id, created_at, name, consumer_id, service_id, route_id, config, enabled, cache_key, protocols, tags, ws_id, instance_name, updated_at) VALUES ('0e1ed9d6-c147-406a-8b55-0517a2d09402', '2024-03-12 09:17:28+00', 'request-transformer', NULL, NULL, '6461b998-bb77-49c0-8882-92709ea65ec1', '{"add": {"body": ["chave_no_body:4561"], "headers": ["x-meu-novo-cabecalho:valor11"], "querystring": ["querystring_na_area:ola tudo bem? joia"]}, "append": {"body": [], "headers": [], "querystring": []}, "remove": {"body": [], "headers": [], "querystring": []}, "rename": {"body": [], "headers": [], "querystring": []}, "replace": {"uri": null, "body": [], "headers": [], "querystring": []}, "http_method": null}', true, 'plugins:request-transformer:6461b998-bb77-49c0-8882-92709ea65ec1::::75ea5b5c-5799-42ab-b2b0-8bb9caa3a3a1', '{http,https}', '{service-three-python}', '75ea5b5c-5799-42ab-b2b0-8bb9caa3a3a1', 'service-three-python-route-v4-request-transformer-plugin', '2024-03-12 09:20:44+00');
